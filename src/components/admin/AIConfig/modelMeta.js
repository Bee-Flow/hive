// Human-readable metadata for AI models
const MISTRAL_MODEL_META = {
    // --- Frontier: Generalist ---
...
// Get metadata for a model ID (fuzzy match on prefix)
const getModelMeta = (id) => {
    if (MISTRAL_MODEL_META[id]) return MISTRAL_MODEL_META[id];
    // Try matching by prefix (e.g. 'mistral-large-2411' matches 'mistral-large')
...
export { MISTRAL_MODEL_META, getModelMeta, CAT_COLORS };
