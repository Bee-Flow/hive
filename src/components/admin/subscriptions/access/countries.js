// ISO 3166-1 alpha-2 country list for the signup geo-restriction picker.
// Codes here are matched against geoip-lite's country_code on the server
// (see server/auth/signupGuards.js + server/core/serverGeoResolver.js).
...
// EU + EEA + GDPR-adequate set — mirrors EU_EEA_COUNTRIES in
// server/core/serverGeoResolver.js. Used by the "EU/EEA preset" button.
export const EU_EEA = [
...
// Country code → flag emoji (same trick as serverGeoResolver.countryFlag).
