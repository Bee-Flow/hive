            ...
            <div className="flex-shrink-0 px-6 py-4 border-b border-[var(--border-subtle)]">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <h1 className="text-[17px] font-bold text-[var(--text-primary)] leading-tight">{t('ticket_assistant.title')}</h1>
                            <p className="text-[12px] text-[var(--text-tertiary)] leading-tight">{t('ticket_assistant.subtitle')}</p>
                        </div>
                    </div>
                    ...
                    <button onClick={() => setShowAddModal(true)}
                        ...
                        {t('ticket_assistant.connect_mailbox')}
                    </button>
                </div>
            </div>
            ...
            <div className="flex-1 min-h-0 flex">
                {loading ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
                        ...
                        <h3 className="text-[16px] font-semibold text-[var(--text-primary)] mb-1">{t('ticket_assistant.no_connections')}</h3>
                        <p className="text-[13px] text-[var(--text-tertiary)] max-w-sm mb-4">{t('ticket_assistant.no_connections_desc')}</p>
                        <button onClick={() => setShowAddModal(true)}
                    ...
                    <>
                        ...
                        {selectedConn ? (
                            ...
                            <div className="flex-1 flex items-center justify-center text-[13px] text-[var(--text-tertiary)]">
                                {t('ticket_assistant.no_mailbox_selected')}
                            </div>
                        )}
                    </>
                )}
