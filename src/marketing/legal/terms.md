...
- **Authorised User** means an employee, contractor or agent of the Customer who is authorised by the Customer to use the Service under the Customer's account.
- **Customer Content** means any data, prompts, files, documents, conversations, agent configurations, knowledge-base material or other content that the Customer or an Authorised User submits to or generates within the Service.
- **Order** means a written or online order for the Service, including any plan selected via the self-service signup flow.
...
- All activities that occur under the Customer's account, including those of Authorised Users.
...
- Upload or generate content that is unlawful, defamatory, infringing, harmful, harassing, deceptive, or that contains malware.
...
- Scrape, copy, or systematically extract data from the Service, except via documented APIs and within their published rate limits.
- Circumvent or attempt to circumvent rate limits, usage quotas, authentication or other access controls.
- Use the Service to build a competing product, or to benchmark for the benefit of a competitor.
- Resell, sublicense, or provide the Service to third parties (other than Authorised Users) without a written agreement.
- Use the Service to send unsolicited communications (spam) or to violate the rights of any third party.

## 4. Subscription, fees and payment

Subscriptions are billed in advance through Stripe Payments Europe, Limited. By providing payment information, the Customer authorises Bee Flow (or its payment processor) to charge the applicable fees to the chosen payment method.
...
Free or trial plans are offered at our discretion and may be modified or terminated at any time.

## 5. Customer Content

The Customer retains all rights, title and interest in and to the Customer Content. The Customer grants Bee Flow a worldwide, non-exclusive, royalty-free licence to host, copy, transmit, display, process and otherwise use the Customer Content **solely as necessary to provide and improve the Service for the Customer**, and to comply with legal obligations.

The Customer is solely responsible for the Customer Content and for ensuring that it has all rights, consents and authorities required to submit it to the Service.

Bee Flow does **not** use Customer Content to train, fine-tune, or improve generalised or non-personalised AI models. Where Customer Content is forwarded to third-party AI model providers as part of providing the Service, we contractually require those providers to follow equivalent no-training / no-retention practices where available.

## 6. Intellectual property

The Service, including all software, designs, text, graphics, trade marks and other materials (excluding Customer Content), is and remains the exclusive property of Bee Flow and its licensors. Nothing in these Terms transfers any intellectual property rights in the Service to the Customer.

The Customer may provide feedback, suggestions or ideas about the Service. The Customer grants Bee Flow a perpetual, irrevocable, royalty-free licence to use such feedback without obligation or attribution.

## 7. Third-party services

The Service may integrate with or rely on services provided by third parties (including Google, Stripe, AI model providers and hosting providers). The Customer's use of those third-party services is governed by the relevant third party's terms and policies. Bee Flow is not responsible for the acts, omissions or content of any third party.

## 8. Confidentiality

Each party may have access to non-public information of the other ("**Confidential Information**"). Each party agrees: (a) to use the other party's Confidential Information only as needed to perform under these Terms; (b) to protect it with at least the same care it uses for its own confidential information, and not less than a reasonable standard of care; and (c) not to disclose it to any third party except to its employees, contractors and agents bound by equivalent confidentiality obligations.

Confidential Information does not include information that is publicly known through no fault of the receiving party, was lawfully known prior to disclosure, is independently developed without use of the disclosing party's Confidential Information, or is rightfully received from a third party without restriction.

## 9. Data protection

Bee Flow processes personal data in accordance with its [Privacy Policy](/privacy) and applicable data protection law, including the GDPR. Where Bee Flow acts as a processor of personal data on behalf of the Customer, the parties will enter into a data processing agreement (DPA) that forms part of these Terms.

## 10. Warranties and disclaimers

The Service uses AI models that can produce inaccurate, incomplete or otherwise inappropriate output. The Customer is solely responsible for reviewing and validating any output before relying on it. The Service is **not** intended to provide legal, medical, financial or other professional advice.
...
- Bee Flow is not liable for any indirect, incidental, consequential, special, exemplary or punitive damages, or for loss of profits, revenue, goodwill, data or business opportunities, even if advised of the possibility of such damages.
- Bee Flow's total aggregate liability arising out of or in connection with these Terms, regardless of the legal theory, is limited to the amount of fees actually paid by the Customer to Bee Flow under the affected Order in the **twelve (12) months** preceding the event giving rise to the liability.
...
These Terms commence on the date the Customer first agrees to them and continue for the Subscription Term, renewing as described in Section 4 unless terminated.

Either party may terminate these Terms:

- For convenience at the end of the then-current Subscription Term, by cancelling through the account dashboard or by written notice before the renewal date.
- For material breach by the other party, if the breach is not cured within 30 days of written notice describing the breach.
- Immediately by written notice, if the other party becomes insolvent, enters into bankruptcy, suspension of payments, or analogous proceedings.

Bee Flow may suspend the Service immediately and without prior notice in cases of serious abuse, security risk, non-payment, or violation of Section 3 (Acceptable Use).

On termination: (a) the Customer's right to access the Service ends; (b) the Customer remains liable for any fees accrued; (c) the Customer Content will be available for export for a reasonable period (typically 30 days) and will then be deleted in accordance with our retention practices.

Sections that by their nature should survive termination (including Sections 5, 6, 8, 10, 11, 12, 15 and 16) shall survive.

## 14. Force majeure

Neither party is liable for any failure or delay in performance to the extent caused by events beyond its reasonable control, including natural disasters, acts of war or terrorism, civil unrest, pandemic, internet or telecommunications failures, or governmental action.
