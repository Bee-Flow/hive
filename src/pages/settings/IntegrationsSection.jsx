...
const IntegrationRow = ({ icon, name, description, connected, badge, children }) => {
    ...
    return (
        <div style={{ borderBottom: '1px solid var(--border-subtle)' }}>
            <button
                className="w-full flex items-center gap-2.5 py-3 rounded-lg px-2 transition-colors text-left"
...
// ── Fireflies.ai ────────────────────────────────────────────────────────────
const FirefliesIntegration = ({ hasFirefliesKey, onSaved }) => {
    ...
    return (
        <IntegrationRow
            ...
            icon={
                <svg viewBox="22 20 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '18px', height: '18px' }}>
                    <path d="M30.5749 22H24V28.5267H30.5749V22Z" fill="url(#ffs_g1b)" />
                    <path d="M38.3633 29.8789H31.7883V36.4056H38.3633V29.8789Z" fill="url(#ffs_g2b)" />
                    <path d="M38.3633 22H31.7883V28.5267H43.9998V27.594C43.9997 26.1104 43.4058 24.6875 42.3489 23.6384C41.2919 22.5894 39.8585 22 38.3638 22H38.3633Z" fill="url(#ffs_g3b)" />
                    <path d="M24 29.8789V36.4056C24.0002 37.8892 24.594 39.3121 25.6509 40.3612C26.7079 41.4103 28.1413 41.9996 29.636 41.9996H30.5749V29.8789H24Z" fill="url(#ffs_g4b)" />
                    <defs>
                        <linearGradient id="ffs_g1b" x1="40.08" y1="38.51" x2="12.44" y2="9.47" gradientUnits="userSpaceOnUse"><stop stopColor="#E82A73" /><stop offset="0.54" stopColor="#9B4AB0" /><stop offset="1" stopColor="#3B73FF" /></linearGradient>
                        <linearGradient id="ffs_g2b" x1="40.18" y1="38.42" x2="12.54" y2="9.38" gradientUnits="userSpaceOnUse"><stop stopColor="#FF3C82" /><stop offset="0.49" stopColor="#B251B2" /><stop offset="1" stopColor="#3B73FF" /></linearGradient>
                        <linearGradient id="ffs_g3b" x1="44.77" y1="34.05" x2="35.4" y2="0.12" gradientUnits="userSpaceOnUse"><stop stopColor="#E82A73" /><stop offset="0.54" stopColor="#9B4AB0" /><stop offset="1" stopColor="#3B73FF" /></linearGradient>
                        <linearGradient id="ffs_g4b" x1="35.55" y1="42.82" x2="2.03" y2="32.61" gradientUnits="userSpaceOnUse"><stop stopColor="#E82A73" /><stop offset="0.54" stopColor="#9B4AB0" /><stop offset="1" stopColor="#3B73FF" /></linearGradient>
                    </defs>
                </svg>
            }
        >
            ...
            <p className="text-[11px] mt-1.5" style={{ color: 'var(--text-muted)' }}>
                Get your key from <a href="https://app.fireflies.ai/integrations/custom/fireflies" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: 'var(--accent-primary)' }}>app.fireflies.ai</a>
            </p>
        </IntegrationRow>
    );
};
...
// ── YouTrack ────────────────────────────────────────────────────────────────
const YouTrackIntegration = ({ hasYouTrackConfig, onSaved }) => {
    ...
    return (
        <IntegrationRow
            ...
            icon={
                <svg viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '22px', height: '22px' }}>
                    <defs>
                        <linearGradient id="yt_g1b" x1="12" y1="58" x2="58" y2="12" gradientUnits="userSpaceOnUse">
                            <stop stopColor="#FC3791" /><stop offset="0.52" stopColor="#9B4AB0" /><stop offset="1" stopColor="#6166E8" />
                        </linearGradient>
                    </defs>
                    <rect width="70" height="70" rx="14" fill="url(#yt_g1b)" />
                    <path d="M16 18h38v34H16z" fill="white" fillOpacity="0.9" />
                    <path d="M20 25h20v3H20zM20 32h28v3H20zM20 39h14v3H20z" fill="url(#yt_g1b)" />
                </svg>
            }
        >
            <div className="space-y-2 mt-1">
                <input type="text" value={url} onChange={e => setUrl(e.target.value)}
                    ...
                    className="w-full px-3 py-2 rounded-lg border outline-none text-sm focus:border-[var(--accent-primary)] transition-colors"
                    style={{ background: 'var(--bg-secondary)', borderColor: 'var(--border-default)', color: 'var(--text-primary)' }} />
                <div className="flex gap-2">
                    <input type="password" value={token} onChange={e => setToken(e.target.value)}
                        ...
                        className="flex-1 px-3 py-2 rounded-lg border outline-none text-sm focus:border-[var(--accent-primary)] transition-colors"
                        style={{ background: 'var(--bg-secondary)', borderColor: 'var(--border-default)', color: 'var(--text-primary)' }}
                        onKeyDown={e => e.key === 'Enter' && url.trim() && token.trim() && save()} />
                    <button onClick={save} disabled={saving || (!url.trim() && !token.trim())}
                ...
                <p className="text-[11px]" style={{ color: 'var(--text-muted)' }}>
                    Token from <a href="https://www.jetbrains.com/help/youtrack/server/manage-permanent-token.html" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: 'var(--accent-primary)' }}>YouTrack → Profile → Authentication</a>
                </p>
            </div>
        </IntegrationRow>
    );
...
// ── Gamma ────────────────────────────────────────────────────────────────────
const GammaIntegration = ({ hasGammaKey, onSaved }) => {
    const [key, setKey] = useState('');
    const [saving, setSaving] = useState(false);
    ...
    return (
        <IntegrationRow
            ...
            icon={
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '20px', height: '20px' }}>
                    <rect x="2" y="2" width="20" height="20" rx="4" fill="url(#gamma_gb)" />
                    <path d="M7 8h10v1.5H7zM7 12h8v1.5H7zM7 16h5v1.5H7z" fill="white" fillOpacity="0.9" />
                    <defs>
                        <linearGradient id="gamma_gb" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse">
        ...
        >
            ...
            <p className="text-[11px] mt-1.5" style={{ color: 'var(--text-muted)' }}>
                Get key from <a href="https://gamma.app/settings" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: 'var(--accent-primary)' }}>gamma.app/settings</a> → API Tokens
            </p>
        </IntegrationRow>
    );
};
...
// ── LinkedIn ────────────────────────────────────────────────────────────────
const LinkedInIntegration = ({ connected, linkedInName, hasLinkedInConfig, onSaved }) => {
    ...
    React.useEffect(() => {
        const handler = (e) => {
            if (e.data?.type === 'linkedin-callback' && e.data?.success) {
                onSaved();
            }
        };
    ...
    const handleConnect = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                window.open(url, 'linkedin-oauth', `width=${w},height=${h},left=${left},top=${top}`);
            }
        } catch (e) { console.error(e); }
    ...
    const handleDisconnect = async () => {
        ...
        try {
            await authFetch(`${API_BASE}/api/integrations/linkedin/disconnect`, { method: 'POST' });
            onSaved();
        } catch (e) { console.error(e); }
        ...
        <IntegrationRow
            ...
            icon={
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '20px', height: '20px' }}>
                    ...
                    <path d="M7.5 9.5h2v7h-2v-7zm1-3.2a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4zm3.5 3.2h1.9v1h0c.27-.5 .92-1.1 1.9-1.1 2 0 2.4 1.3 2.4 3.1v3.6h-2v-3.2c0-.8 0-1.8-1.1-1.8s-1.3.9-1.3 1.7v3.3h-2v-6.6z" fill="white" />
                </svg>
            }
        >
            <div className="mt-1 flex items-center gap-2">
                {!hasLinkedInConfig && (
                    <p className="text-[11px]" style={{ color: 'var(--text-muted)' }}>
                        LinkedIn not configured. Ask your admin to set it up in Admin → Integrations.
                    </p>
                )}
...
const WhatsAppIntegration = ({ onSaved }) => {
    ...
    const handleConnect = async () => {
        ...
        setQrDataUrl(null);
        try {
            const res = await authFetch(`${API_BASE}/api/integrations/whatsapp/connect`, {
                method: 'POST',
            });
            if (res.ok) {
                const data = await res.json();
    ...
    const startPolling = () => {
        ...
        const interval = setInterval(async () => {
            try {
                const res = await authFetch(`${API_BASE}/api/integrations/whatsapp/qr`);
                if (res.ok) {
                    const data = await res.json();
                    if (data.connected) {
                        setStatus('connected');
    ...
    const handleDisconnect = async () => {
        setDisconnecting(true);
        try {
            await authFetch(`${API_BASE}/api/integrations/whatsapp/disconnect`, { method: 'POST' });
            setStatus('disconnected');
            setQrDataUrl(null);
            onSaved?.();
        } catch (e) { console.error(e); }
                ...
                {qrDataUrl && !isConnected && (
                    <div className="flex flex-col items-center gap-3 py-2">
                        ...
                        <div className="p-2 bg-white rounded-xl shadow-lg">
                            <img src={qrDataUrl} alt="WhatsApp QR Code" style={{ width: '200px', height: '200px' }} />
                        </div>
