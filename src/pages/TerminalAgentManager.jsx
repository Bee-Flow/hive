                                                ...
                                                <div className="space-y-6 animate-fadeIn">
                                                    ...
                                                    <div className="flex items-center gap-3 p-4 rounded-xl bg-[var(--bg-tertiary)] border border-[var(--border-subtle)]">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <p className="text-[var(--text-secondary)] text-xs">Structured chain-of-thought reasoning tool for breaking down complex problems.</p>
                                                        </div>
                                                        <input
                                                    ...
                                                    {/* Thinking Model (shown when ST is enabled) */}
                                                    {selected.config?.sequentialThinkingEnabled && (
                                                        <div className="ml-2 p-4 rounded-xl bg-purple-500/5 border border-purple-500/15">
                                                            ...
                                                            <ModelSelector
                                                                ...
                                                                compact
                                                            />
                                                            <p className="text-[10px] text-muted mt-1.5 opacity-60">When set, this model thinks first outside the terminal, then the main model acts using those insights.</p>
                                                        </div>
                                                    )}
                                                </div>
                                            )}
